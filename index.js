...
app.use(
  cors({
    origin: ["https://librarymanagement-5c043.web.app"],
    credentials: true,
  })
);
...
async function run() {
  try {
    ...
    // borrow collection fileds will be 1.return date 2.email and 3.name fields

    // step 01. make a database collection for borrow
    ...
    // step 03: By clicking the Submit button, the quantity of that specific book  will be reduced by 1

    // step 04: Also, the book will be added to the `Borrowed Books` collection

    // step 05:  If the  quantity reduces to 0, disable the `Borrow` button

    // step 06:  The quantity can't be negative

    // step 07:  all the borrowd infor show the borrowd page according specific user
